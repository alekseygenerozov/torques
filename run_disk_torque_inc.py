...
while (dd>0.05) and (i<4):
	...
	bc.bash_command('/projects/alge9397/code/c/torques/rebound_disk_inc {0} {1} {2} {3} {4} {5}'.format(e1, a1, ang, idx, 0,  No))
	bc.bash_command('/projects/alge9397/code/c/torques/rebound_disk_inc {0} {1} {2} {3} {4} {5}'.format(e1, a1, ang, idx, 1,  No))
